...
-- ----------------------------
-- Table structure for real_sign_area
-- ----------------------------
...
-- ----------------------------
-- Table structure for real_sign_area_owner
-- ----------------------------
...
-- ----------------------------
-- Table structure for real_sign_area_position
-- ----------------------------
DROP TABLE IF EXISTS `real_sign_area_position`;
CREATE TABLE `real_sign_area_position` (
  `real_sign_area_position_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `real_sign_area_id` int(11) unsigned DEFAULT 0 COMMENT 'The real_sign_area whose path will be adjusted by the transform_matrix in this table.',
  `transform_matrix` longtext NOT NULL DEFAULT '{matrix:[[1,0,0],[0,1,0]]}' COMMENT 'This is the transform matrix used to position a `real_sign_area`.`path` within the coordinate system of the virtual scroll.',
  PRIMARY KEY (`real_sign_area_position_id`),
  KEY `fk_real_sign_area_position_to_real_sign_area` (`real_sign_area_id`),
  CONSTRAINT `fk_real_sign_area_position_to_real_sign_area` FOREIGN KEY (`real_sign_area_id`) REFERENCES `real_sign_area` (`real_sign_area_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for real_sign_area_position_owner
-- ----------------------------
DROP TABLE IF EXISTS `real_sign_area_position_owner`;
CREATE TABLE `real_sign_area_position_owner` (
  `real_sign_area_position_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `scroll_version_id` int(11) unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (`real_sign_area_position_id`,`scroll_version_id`),
  KEY `fk_real_sign_area_position_owner_to_scroll_version` (`scroll_version_id`),
  CONSTRAINT `fk_real_sign_area_position_owner_to_real_sign_area_position` FOREIGN KEY (`real_sign_area_position_id`) REFERENCES `real_sign_area_position` (`real_sign_area_position_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_real_sign_area_position_owner_to_scroll_version` FOREIGN KEY (`scroll_version_id`) REFERENCES `scroll_version` (`scroll_version_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=1606 DEFAULT CHARSET=utf8 COMMENT='Description of a reconstructed scroll or combination.';
...
) ENGINE=InnoDB AUTO_INCREMENT=1606 DEFAULT CHARSET=utf8 COMMENT='This table provides a unique group id for scrollversions and the possibilty to lock all members of the group';
...
-- ----------------------------
-- Table structure for sign_attribute
-- ----------------------------
...
-- ----------------------------
-- Table structure for sign_attribute_owner
-- ----------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='This table stores the data of all registered users,\nCreated by Martin 17/03/03';
