...
-- ----------------------------
-- Table structure for discrete_canonical_reference
-- ----------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=1734254 DEFAULT CHARSET=utf8 COMMENT='This table describes signs on a manuscript.  Currently this includes both characters and spaces, it could perhaps also include other elements that one might want to define as a sign.';
...
) ENGINE=InnoDB AUTO_INCREMENT=747512 DEFAULT CHARSET=utf8 COMMENT='Contains data related to the readability of a sign.';
...
) ENGINE=InnoDB AUTO_INCREMENT=6078 DEFAULT CHARSET=utf8 COMMENT='This table describes the position of a character in relation to the text it is related to. ';
