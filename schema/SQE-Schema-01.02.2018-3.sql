...
) ENGINE=InnoDB AUTO_INCREMENT=1385 DEFAULT CHARSET=utf8 COMMENT='This table defines the location and rotation of an artefact within the scroll.';
...
CREATE TABLE `edition_catalog_to_discrete_reference` (
  ...
  PRIMARY KEY (`edition_id`,`discrete_canonical_reference_id`),
  ...
  CONSTRAINT `fk_ed_cat_to_disc_ref_to_edition_id` FOREIGN KEY (`edition_id`) REFERENCES `edition_catalog` (`edition_catalog_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `image_to_edition_catalog` (
  ...
  PRIMARY KEY (`edition_id`,`catalog_id`),
  KEY `fk_to_catalog_id` (`catalog_id`),
  CONSTRAINT `fk_to_catalog_id` FOREIGN KEY (`catalog_id`) REFERENCES `image_catalog` (`image_catalog_id`),
  CONSTRAINT `fk_to_edition_id` FOREIGN KEY (`edition_id`) REFERENCES `edition_catalog` (`edition_catalog_id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=1231 DEFAULT CHARSET=utf8 COMMENT='This table defines unique versions of a reconstructed scroll.';
